...
//const forecastDayly = document.querySelector('#forecast-dayly')
...
const showBtn4 = document.querySelector('.btn4')
const showBtn5 = document.querySelector('.btn5')
const showBtn6 = document.querySelector('.btn6')
...
const bgColorDay1 = document.querySelector('.dayly1')
const bgColorDay2 = document.querySelector('.dayly2')
const bgColorDay3 = document.querySelector('.dayly3')
const bgColorDay4 = document.querySelector('.dayly4')
const bgColorDay5 = document.querySelector('.dayly5')
const bgColorDay6 = document.querySelector('.dayly6')
...
function weatherApp(data){
    ...
    //                     <ul>
    //                         <li>${day.date}</li>
    //                         <li>${day.day.condition.icon}</li>
    //                         <li>${day.day.maxtemp_c}&#176 C</li>
    //                         <li>${day.day.mintemp_c}&#176 C</li>
    //                     </ul>
    //                 </div>
    //         `
    //     }
    // })
    // forecastDayly.innerHTML = otherDayForecast;
    ...
    //hour1.innerHTML = moment.unix(data.forecast.forecastday[0].hour[1].time_epoch).format('HH:mm a');

    let currenthour =  moment.unix(data.location.localtime_epoch).format('HH:mm a');
    ...
    //n = data.forecast.forecastday[0].hour

    // let a = []
    // for(i = 0; i < a.length; i++)
    // {
    //     if(data.forecast.forecastday[0].a[i].time_epoch >= currenthour)
    //     {
    //         otherHourForecast += `
    //         <div class="hourly">
    //                     <ul>
    //                         <li class="hour1">${moment.unix(data.forecast.forecastday[0].hour[i+1].time_epoch).format('HH:mm a')}</li>
    //                         <li>image</li>
    //                         <li>26&#176; C</li>
    //                     </ul>
    //                 </div>
    ...
    //     }
    // }
    // forecastHourly.innerHTML = otherHourForecast;

    // show detailDay1
    const detailIcon1 = document.querySelector('.detail-item1 .detail-icon')
    ...
    // show detailDay2
    const detailIcon2 = document.querySelector('.detail-item2 .detail-icon')
    ...
    // show detailDay3
    const detailIcon3 = document.querySelector('.detail-item3 .detail-icon')
    ...
    // show detailDay4
    const detailIcon4 = document.querySelector('.detail-item4 .detail-icon')
    ...
    // show detailDay5
    const detailIcon5 = document.querySelector('.detail-item5 .detail-icon')
    ...
    // show detailDay6
    const detailIcon6 = document.querySelector('.detail-item6 .detail-icon')
...
showBtn1.addEventListener('click', function(){
    ...
    showBtn4.classList.remove("active");
    showBtn5.classList.remove("active");
    showBtn6.classList.remove("active");
    ...
    bgColorDay1.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
    bgColorDay2.style.backgroundColor = 'transparent'
    bgColorDay3.style.backgroundColor = 'transparent'
    bgColorDay4.style.backgroundColor = 'transparent'
    bgColorDay5.style.backgroundColor = 'transparent'
    bgColorDay6.style.backgroundColor = 'transparent'
})
showBtn2.addEventListener('click', function(){
    ...
    bgColorDay1.style.backgroundColor = 'transparent'
    bgColorDay2.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
    bgColorDay3.style.backgroundColor = 'transparent'
    bgColorDay4.style.backgroundColor = 'transparent'
    bgColorDay5.style.backgroundColor = 'transparent'
    bgColorDay6.style.backgroundColor = 'transparent'
...
showBtn3.addEventListener('click', function(){
    ...
    bgColorDay1.style.backgroundColor = 'transparent'
    bgColorDay2.style.backgroundColor = 'transparent'
    bgColorDay3.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
    bgColorDay4.style.backgroundColor = 'transparent'
    bgColorDay5.style.backgroundColor = 'transparent'
    bgColorDay6.style.backgroundColor = 'transparent'
})
showBtn4.addEventListener('click', function(){
    ...
    bgColorDay2.style.backgroundColor = 'transparent'
    bgColorDay3.style.backgroundColor = 'transparent'
    bgColorDay4.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
    bgColorDay5.style.backgroundColor = 'transparent'
    bgColorDay6.style.backgroundColor = 'transparent'
})
showBtn5.addEventListener('click', function(){
    ...
    bgColorDay3.style.backgroundColor = 'transparent'
    bgColorDay4.style.backgroundColor = 'transparent'
    bgColorDay5.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
    bgColorDay6.style.backgroundColor = 'transparent'
})
showBtn6.addEventListener('click', function(){
    ...
    bgColorDay4.style.backgroundColor = 'transparent'
    bgColorDay5.style.backgroundColor = 'transparent'
    bgColorDay6.style.backgroundColor = 'rgba(211, 211, 211, 0.423)'
})